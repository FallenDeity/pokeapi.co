---
title: How to Write How-To Guides
...
3. **Register your guide in the Sidebar**
   Open [astro.config.mjs](file:///d:/projects/pokeapi.co/astro.config.mjs) and find the `sidebar` configuration. Add your guide to the `items` array under the **How-To Guides** section:
